...
module.exports = function (chai, openApiSpecs) {
  const { Assertion } = chai;

  Assertion.addChainableMethod('satisfyApiSpec', function (specName = 'default') {
    const actualResponse = responseFactory.makeResponse(this._obj); // eslint-disable-line no-underscore-dangle
    const openApiSpec = openApiSpecs[specName] || openApiSpecs.default;
